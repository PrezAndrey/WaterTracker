...
//        
//        
//        let newInterval = UserSettings.calculateStartDayInterval(setDate: Date())
...
//            WaterRecord(waterAmount: 100.0, date: dateFormatter.date(from: "2022-05-22 21:19") ?? Date()),
//            WaterRecord(waterAmount: 100.0, date: dateFormatter.date(from: "2022-05-22 21:15") ?? Date())
//        ]
//        waterStore.addRecord(WaterRecord(waterAmount: 100.0, date: dateFormatter.date(from: "2022-05-22 21:19") ?? Date()))
//        waterStore.addRecord(WaterRecord(waterAmount: 100.0, date: dateFormatter.date(from: "2022-05-22 21:29") ?? Date()))
//        
//        let waterAmount = waterModel.waterAmount
//        print(Date())
//        
//        
//        XCTAssertEqual(200, waterAmount)
//    }
